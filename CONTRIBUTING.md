...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Password-Strength-Analyzer.git`
...
```bash
# Clone the repo
git clone https://github.com/Qyroxen/Password-Strength-Analyzer.cd
